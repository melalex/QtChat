...
#include "../../ChatClient/registration.h"
...
QT_MOC_LITERAL(1, 13, 16), // "registerANewUser"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 5), // "login"
QT_MOC_LITERAL(4, 37, 8), // "password"
QT_MOC_LITERAL(5, 46, 15), // "confirmPassword"
QT_MOC_LITERAL(6, 62, 21) // "on_pushButton_clicked"

    },
    "Registration\0registerANewUser\0\0login\0"
    "password\0confirmPassword\0on_pushButton_clicked"
};
...
void Registration::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Registration::*_t)(QString , QString , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Registration::registerANewUser)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Registration::registerANewUser(QString _t1, QString _t2, QString _t3)
{
